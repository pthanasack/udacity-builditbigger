Personal project for Udacity Android Developer Course
This Gradle project is an app with paid and free flavors, uses multiple libraries (Android, Java) and Google Cloud Endpoints
